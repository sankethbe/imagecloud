...
<!--																											-->
<!-- Purpose: Provide an interface to the S3 API																-->
<!-- *+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+*+ -->
<?PHP
	class S3
	{	
		var $_key        = "";
		var $_secret     = "";
		var $_server     = "http://s3.amazonaws.com";	// EC2 web service URL
		...
		// recursively delete the object in the specified bucket
		...
		// delete the object in the specified bucket
		...
		// download the object in the specified object
		...
		// make sure the result doesn't contain an error
		...
		// check if the object exists in the specified object
		function objectExists($bucket, $object)
		{
			return ($this->getObjectInfo($bucket, $object) !== false);
		}

		// retrieve the specified object header
		...
		// retrieve the type of the object in the specified object
		...
		// create the require request signature
